...
<c:if test="${not empty errorMessage}">
    <div class="flex items-center bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4" role="alert">
        ...
        <form:form action="addCourse" class="bg-white p-6 rounded-lg shadow-md" enctype="multipart/form-data" method="post" modelAttribute="courseRegister">
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <form:textarea class="border border-gray-300 rounded-lg py-2 px-4 w-full" path="description" placeholder="Enter course description" rows="4"></form:textarea>
            ...
            <div class="flex items-center justify-between">
                <button class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700" type="submit">Add Course</button>
            </div>
        </form:form>
    </main>
