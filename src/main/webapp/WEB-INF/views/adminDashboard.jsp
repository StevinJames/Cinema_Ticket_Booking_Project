        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="flex items-center space-x-4">
                <ul class="flex space-x-4">
                    <li><a class="hover:underline" href="${pageContext.request.contextPath}/admin/home">Home</a></li>
                    <li><a class="hover:underline" href="${pageContext.request.contextPath}/admin/approvedCourselist">Approved Courses</a></li>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <c:forEach var="course" items="${course}"> 
                <div class="bg-white p-4 rounded-lg shadow-md">
                    ...
                    <h3 class="text-xl font-bold mt-2">Teacher: ${course.teacher.userName}</h3>
                    ...
                    <div class="flex justify-center space-x-2 mt-2">
                        <a 
                            href="${pageContext.request.contextPath}/course/approveCourse/${course.id}" 
                            class="bg-green-600 text-white px-4 py-2 rounded shadow-lg transition duration-300 ease-in-out transform hover:bg-green-700 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-400">
                            Approve
                        </a>
                        <a 
                        ...
                        <a 
                            href="${pageContext.request.contextPath}/course/rejectCourse/${course.id}" 
                            class="bg-red-600 text-white px-4 py-2 rounded shadow-lg transition duration-300 ease-in-out transform hover:bg-red-700 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-red-400">
                            Reject
                        </a>
                    </div>
                </div>
