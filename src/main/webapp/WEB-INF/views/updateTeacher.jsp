...
<body class="flex items-center justify-center min-h-screen bg-gray-900 bg-opacity-50">
    <div class="absolute top-0 left-0 w-full p-4 flex justify-between items-center bg-white bg-opacity-80 shadow-md z-10">
        ...
        <nav class="space-x-4">
            ...
            <a href="#" class="text-black border border-white px-4 py-2 rounded hover:bg-white hover:text-gray-900">Logout</a>
        </nav>
    </div>
    ...
    <div class="bg-white bg-opacity-80 p-8 rounded-lg shadow-lg max-w-sm w-full">
        ...
        <form:form action="${pageContext.request.contextPath}/teacher/updateTeacher" method="post" modelAttribute="teacher" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <form:input path="email" id="email" type="email" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter your email" readonly="readonly" />
            </div>
            ...
            <!-- Submit Button -->
            <button type="submit" class="w-full bg-gray-800 text-white py-2 rounded hover:bg-gray-900">Update Profile</button>
        </form:form>

        <p class="mt-4 text-center text-gray-700">Wanna go back? <a href="${pageContext.request.contextPath}/teacher/dashboard" class="text-blue-500 hover:underline">Dashboard</a></p>
    </div>
</body>
</html>
